  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <input class="form-control" type="text" name='keluhan' value="<?php echo $d['keluhan']; ?>" placeholder="Keluhan Baru..." required>


          <P><b>Diagnosa Pasien:</b></p>
        <input class="form-control" type="text" name='diagnosa' value="<?php echo $d['diagnosa']; ?>" placeholder="Diagnosa Baru..." required>
