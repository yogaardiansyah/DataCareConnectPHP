                ...
                <div class="card-body">
                      ...
                      <div class="col-md-6">
                        ...
                        <form action='' name='kirim' method='post'>
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control form-control-sm" type="text" placeholder="Nama Pasien..." aria-label=".form-control-sm example" name='nama' required>
                          </div>
                          ...
                          <div class="form-group">
                            <label>Alamat:</label>
                            <input class="form-control form-control-sm" type="text" placeholder="Alamat Pasien..." aria-label=".form-control-sm example" name='alamat' required>
                          </div>
                  ...
                  if (isset($_POST['kirim'])) {
                    ...
                    if ($chak > 0) {
                      ...
                      echo "<div class='alert alert-warning mt-4 ml-5 text-center' role='alert'>";
                      echo "<p>Data Yang Anda Kirim Sudah Tersedia</p>";
                      echo "</div>";
                      echo "</div>";
                    } else {
