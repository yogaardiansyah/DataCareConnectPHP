        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h4 class="m-0 font-weight-bold text-info">Data Tenaga Medis Klinik</h4>
            </div>
            <!-- Card Body -->
            <div class="card-body">
              <?php
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-8  mt-4">
                  ...
                  <h7 class="m-0 font-weight-bold">Total Maksimum Tampil Data Tenaga Medis: <?php echo $kap; ?></h7><br>
                  <a href="export_medis.php" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>

                </div>

                <div class="col-md-4 mt-5 ">
                  <form class="form-inline my-2 my-lg-0" action="cari_tenaga.php" method="get" name='cari'>
              ...
              <div class="table-responsive service">
                <table class="table table-bordered table-hover  mt-3 text-nowrap css-serial">
                  ...
                  if (isset($_GET['cari'])) {
                    ...
                    $brg = mysqli_query($conn, "select * from tenagamedis where id like '%" . $cari . "%' or nama like '%" . $cari . "%' ");
                    ...
                    $brg = mysqli_query($conn, "select * from tenagamedis limit $start, $hal");
                  }
                  ...
                  ?>
                      <tbody>
                        <tr>
                          ...
                          <td>&nbsp;<a href="edit_medis.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-success">Edit</button></a> &nbsp; <a href="hapus_medis.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-danger">Hapus</button></a> &nbsp; <a href="detail_medis.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-info">Detail</button></a></td>
                ...
                <nav aria-label="Page navigation example">
                  <ul class="pagination">
                    ...
                    for ($x = 1; $x <= $hal; $x++) {
                    ?>
                      <li class="page-item"><a class="page-link text-info" href="?page=<?php echo $x ?>"><?php echo $x ?></a></li>
                    <?php
                    }
