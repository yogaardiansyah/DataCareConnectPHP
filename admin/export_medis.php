...
function generatePDF($data) {
    ...
    $pdf->SetTitle('Data Tenaga Medis Klinik');
    ...
    $pdf->Cell(0, 10, 'Data Tenaga Medis Klinik', 0, 1, 'C');
    $pdf->SetFont('helvetica', '', 10);

    // Table header
    $pdf->Cell(25, 10, 'No', 1);
    $pdf->Cell(70, 10, 'Nama', 1); // Adjust width according to your layout
    $pdf->Cell(70, 10, 'Alamat', 1); // Adjust width according to your layout
    $pdf->Cell(30, 10, 'Nomor', 1); // Adjust width according to your layout
    $pdf->Ln();
    ...
    foreach ($data as $row) {
        ...
        $pdf->Cell(30, 10, $row['nomor'], 1);
        $pdf->Ln();
    }

    // Save PDF to a file
    $pdf->Output('Data_tenaga_klinik.pdf', 'D');
}
