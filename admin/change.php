      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          ?>
              ...
              <div class="card shadow col-md-12 ml-1 mr-4">
                <div class="card-header py-3">
                  <h4 class="m-0 font-weight-bold text-info">Ganti Password</h4>
                </div>
                ...
                <form action="change_pass.php" method="post">
                  <div class="row ml-5 mb-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <input class="form-control mb-3" type="password" name='ketiga' value="" placeholder="Password Baru..." required>
