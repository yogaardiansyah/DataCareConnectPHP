          ...
          <div class="row mt-5">
            ...
            <div class="col-xl-12 col-lg-8">
                ...
                <div class="card-body">
                    ...
                    <form action='' name='kirim' method='post'>
                      ...
                      <div class="row">
                        <div class="col-md-6 mx-auto">
                          ...
                          <input class="form-control form-control-sm" type="text" id="nama" placeholder="Nama Tenaga Kesehatan..." aria-label=".form-control-sm example" name='nama' required>
                        </div>
                      </div>

                      <div class="row mt-3">
                        <div class="col-md-6 mx-auto">
                          <label for="alamat">Alamat Tenaga Kesehatan:</label>
                          <input class="form-control form-control-sm" type="text" id="alamat" placeholder="Alamat Tenaga Kesehatan..." aria-label=".form-control-sm example" name='alamat' required>
                        </div>
                      </div>

                      <div class="row mt-3">
                        <div class="col-md-6 mx-auto">
                          <label for="nomor">Nomor Tenaga Kesehatan:</label>
                          <input class="form-control form-control-sm" type="number" id="nomor" placeholder="Nomor Handphone..." aria-label=".form-control-sm example" name='nomor' required>
                        </div>
                      </div>

                      <div class="row mt-4">
                        <div class="col-md-6 mx-auto">
                          <button type="submit" class="btn btn-info btn-sm btn-block" name='kirim'>Kirim</button>
                        </div>
                      </div>
                  ...
                  if (isset($_POST['kirim'])) {
                    ...
                    if ($chak > 0) {
                      ...
                      echo "<div class='col-md-10 col-sm-12 col-xs-12 ml-5 text-center'>";
              ...
              '$nomor'
                      ...
                      if ($insert) {
                        echo "<div class='col-md-10 col-sm-12 col-xs-12 text-center'>";
