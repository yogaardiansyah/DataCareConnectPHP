                ...
                <form method="post" name='edit'>
                  <div class="row ml-5 mb-2 mt-3">
                    <div class="col-md-6">
                      ...
                      <input class="form-control" type="text" name='keterangan' value="<?php echo $d['keterangan']; ?>" placeholder="Keterangan Baru..." required>

                      <P><b>Nomor Pasien:</b></p>
                      <input class="form-control" type="text" name='jumlah' value="<?php echo $d['jumlah']; ?>" placeholder="Jumlah Baru..." required>
                  ...
                  <div class="row ml-5 mb-4 mt-3">
                    ...
                    <div class="col-md-5">
                      <button type="submit" class="btn btn-info" name='edit'>Update</button>&nbsp;<input type="reset" class="btn btn-outline-dark" value="Reset">
                    </div>
