                  ...
                  <div class="container col-md-6">
                    <form action='' name='kirim' method='post'>
                      ...
                      <div class="form-group">
                        <label for="nama">Nama Obat Medis:</label>
                        <input class="form-control form-control-sm" type="text" id="nama" placeholder="Nama Obat Medis..." aria-label=".form-control-sm example" name='nama' required>
                      </div>

                      <div class="form-group">
                        <label for="keterangan">Keterangan Obat Medis:</label>
                        <input class="form-control form-control-sm" type="text" id="keterangan" placeholder="Keterangan Obat Medis..." aria-label=".form-control-sm example" name='keterangan' required>
                      </div>

                      <div class="form-group">
                        <label for="jumlah">Stock Obat Medis:</label>
                        <input class="form-control form-control-sm" type="number" id="jumlah" placeholder="Stock Obat Medis..." aria-label=".form-control-sm example" name='jumlah' required>
                      </div>
