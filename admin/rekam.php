  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
              ...
              <div class="card shadow ">
                ...
                <div class="card-body">
                    ...
                    <form action='' name='kirim' method='post'>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name='pasien' required>
                          ...
                          <?php $brg = mysqli_query($conn, "select * from pasien");
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name='tenaga' required>
                          ...
                          <?php $brg = mysqli_query($conn, "select * from tenagamedis");
                          while ($b = mysqli_fetch_array($brg)) { ?>
                            <option value="<?php echo $b['nama']; ?>"><?php echo $b['nama']; ?></option>
                          <?php } ?>
                        </select>
                  ...
                  if (isset($_POST['kirim'])) {
                    ...
                    $manggil = mysqli_query($conn, "select * from obat where nama = '$obat'");
      ...
      '$obat'
                      ...
                      $update = mysqli_query($conn, "UPDATE obat SET jumlah = '$pengurangan' WHERE nama = '$obat'");
                      ...
                      echo "<div class='alert alert-danger mt-4 ml-5' role='alert'>";
                      echo "<p><center>Memasukan Data Gagal</center></p>";
                      echo   "</div>";
                      echo "</div>";
                    }
                  }
