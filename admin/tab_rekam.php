        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h4 class="m-0 font-weight-bold text-info">Data Rekam Medis Klinik</h4>
            </div>
            <!-- Card Body -->
            <div class="card-body">
              <?php
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-8  mt-4">
                  ...
                  <a href="export_rekam.php" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
              ...
              <div class="table-responsive service">
                <table class="table table-bordered table-hover  mt-3 text-nowrap css-serial">
                  ...
                  if (isset($_GET['cari'])) {
                    ...
                    $brg = mysqli_query($conn, "select * from rekammedis where id like '%" . $cari . "%' or nama_pasien like '%" . $cari . "%' ");
                    ...
                    $brg = mysqli_query($conn, "select * from rekammedis limit $start, $hal");
                  }
                  ...
                  ?>
                      <tbody>
                        <tr>
                          ...
                          <td>&nbsp;<a href="edit_rekam.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-success">Edit</button></a> &nbsp; <a href="hapus_rekam.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-danger">Hapus</button></a> &nbsp; <a href="detail_rekam.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-info">Detail</button></a></td>
