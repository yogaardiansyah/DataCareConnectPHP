        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h4 class="m-0 font-weight-bold text-info">Data Obat Klinik</h4>
            </div>
            <!-- Card Body -->
            <div class="card-body">
              <?php
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-8  mt-4">
                  ...
                  <h7 class="m-0 font-weight-bold">Total Maksimum Tampil Data Obat Klinik <?php echo $kap; ?></h7><br>
                  <a href="export_obat.php" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                  ...
                  ?>
                      <tbody>
                        <tr>
                          ...
                          <td>&nbsp;<a href="edit_obat.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-success">Edit</button></a> &nbsp; <a href="hapus_obat.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-danger">Hapus</button></a> &nbsp; <a href="detail_obat.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-outline-info">Detail</button></a></td>
